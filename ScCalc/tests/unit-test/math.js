...
test("basic arithmetics", function () {
	var Problem = new Array("5+5", "3.45+2.78", "0.1+0.2", "0.1+0.04", "12.4+5.07", "3412.578+9.00007","9.00007+3412.578", "5.5+5.5", "1.9999999+0.0000001", 
	...
	var solution = new Array(10, 6.23, 0.3, 0.14, 17.47, 3421.57807,3421.57807, 11, 2,
...
test("long terms", function () {
	...
	var result = new Array( 
							...
							ErrorMsg, 1, 22.25, 1, -2.5, 2, 0.5, 4, 5
						);
